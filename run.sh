...
#         python main.py --lr_init $learning_rate --lr_decay_rate $lr_decay_rate --dataset='CHITaxi' --model='BiDEA' --embed_dim=10 --hid_dim=64 --hid_hid_dim=64 --num_layers=2 --weight_decay=1e-3 --epochs=200 --tensorboard --comment="" --device=3
#     done
# done
